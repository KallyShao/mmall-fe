...
* @Last Modified time: 2017-11-25 18:41:51
*/
...
var navSide = {
    option: {
        ...
        navList: [
            ...
            {name: 'user-center', href: './user-center.html', desc: '个人中心'}, 
            {name: 'order-list', href: './order-list.html', desc: '我的订单'},
            {name: 'pass-update', href: './pass-update.html', desc: '修改密码'},
            {name: 'about', href: './about.html', desc: '关于MMall'}
        ]
    },
